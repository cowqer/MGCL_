...
if __name__ == '__main__':
    ...
    # Tools.print("mIoU (mean):", miou)
    # Tools.print("mIoU (mean):", miou.item() if torch.is_tensor(miou) else miou)
    ...
    for class_idx, class_iou in enumerate(iou):
        print(f"Class {class_idx}: {class_iou.item() if torch.is_tensor(class_iou) else class_iou:.4f}")
