...
from .net_tools_pro import CDModule, MGFEModule_v1,MGFEModule_v2,MGFEModule_v3
...
class SSCDModule_v3(nn.Module):
    ...
    def forward(self, hypercorr_pyramid, query_mask=None):
        ...
        if query_mask is not None:
            _hypercorr_encoded = MGFEModule_v2.update_feature_one(hypercorr_encoded, query_mask)
            _hypercorr_encoded_ = self.SSblock(hypercorr_encoded)         #! SSblock
            hypercorr_encoded = torch.concat([hypercorr_encoded, _hypercorr_encoded, _hypercorr_encoded_], dim=1)
...
class MGCDModule_v1(nn.Module):
    ...
    def forward(self, hypercorr_pyramid, query_mask=None):
        ...
        if query_mask is not None:
            # MGFE
            _hypercorr_encoded = MGFEModule_v1.update_feature_one(hypercorr_encoded, query_mask)
            hypercorr_encoded = torch.concat([hypercorr_encoded, _hypercorr_encoded], dim=1)
        else:
            hypercorr_encoded = torch.concat([hypercorr_encoded, hypercorr_encoded], dim=1)
            pass
...
class MGCDModule_v3(nn.Module):
    ...
    def forward(self, hypercorr_pyramid, query_mask=None):
        ...
        if query_mask is not None:
            # MGFE
            _hypercorr_encoded = MGFEModule_v3.update_feature_one(hypercorr_encoded, query_mask)
            hypercorr_encoded = torch.concat([hypercorr_encoded, _hypercorr_encoded], dim=1)
        else:
            hypercorr_encoded = torch.concat([hypercorr_encoded, hypercorr_encoded], dim=1)
            pass
